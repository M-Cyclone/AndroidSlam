...
public:
  ...
  bool loadFromAndroidTextFile(const std::string& filebuffer);
...
// added by zyd on 2022-9-12
template<class TDescriptor, class F>
bool TemplatedVocabulary<TDescriptor, F>::loadFromAndroidTextFile(const std::string &filebuffer)
{
